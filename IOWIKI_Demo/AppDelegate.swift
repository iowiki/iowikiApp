...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let HomeVCStoryboardId = "HomeVCStoryboardId"
    let SettingsVCStoryboardId = "SettingsVCStoryboardId"
    let MenuVCStoryboardId = "MenuVCStoryboardId"
    ...
    func prepareDrawerViewController() -> KGDrawerViewController {
        ...
        drawerViewController.centerViewController = drawerHomeViewController()
    ...
    func drawerSettingsViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(SettingsVCStoryboardId)
        return viewController
    }
    
    func drawerHomeViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(HomeVCStoryboardId)
        return viewController
    }
    
    private func leftViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(MenuVCStoryboardId)
        return viewController
    }
